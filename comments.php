...
<?php if ($comments) : ?>
	<h3 id="comments"><?php comments_number(__('No comments', 'marthaandtom'), __('One comment', 'marthaandtom'), __('% comments', 'marthaandtom'));?> <?php printf(__('on &#8220;%s&#8221;', 'marthaandtom'), the_title('', '', false)); ?></h3>
